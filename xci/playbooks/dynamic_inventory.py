...
#        idf_file = os.path.dirname(os.path.realpath(__file__)) + "/../var/idf.yml"
        ...
        for host in valid_host:
            ...
            opnfv_admin = opnfv_pdf['opnfv_vm_pdf']['interfaces'][admin_idf_index]
            pxe_idf_index = int(opnfv_idf['opnfv_vm_idf']['net_config']['pxe']['interface'])
            opnfv_public = opnfv_pdf['opnfv_vm_pdf']['interfaces'][pxe_idf_index]
