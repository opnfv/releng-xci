...
scp -r -F $HOME/.ssh/xci-vm-config ${XCI_PATH}/xci/scripts/vm/id_rsa_for_dib xci_vm_opnfv:/home/devuser/.ssh/id_rsa
scp -r -F $HOME/.ssh/xci-vm-config ${XCI_PATH}/xci/scripts/vm/id_rsa_for_dib.pub xci_vm_opnfv:/home/devuser/.ssh/id_rsa.pub
