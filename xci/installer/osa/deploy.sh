...
# DNM: Fact gathering fails due to not having target hosts in the inventory at this
# point. The below line is just added to see how far we can go with the shabump
