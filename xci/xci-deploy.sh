...
#-------------------------------------------------------------------------------
user_local_dev_vars=(OPNFV_RELENG_DEV_PATH OPENSTACK_OSA_DEV_PATH OPENSTACK_KOLLA_ANSIBLE_DEV_PATH OPENSTACK_BIFROST_DEV_PATH)
...
USERNAME=$(ssh -q root@192.168.122.2 awk "/OS_USERNAME=./" $openrc_file)
PASSWORD=$(ssh -q root@192.168.122.2 awk "/OS_PASSWORD=./" $openrc_file)
