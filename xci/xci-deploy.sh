...
set +o nounset
#-------------------------------------------------------------------------------
# To test a proto on infra, set XCI_INFRA_PROTO to the proto name
#-------------------------------------------------------------------------------
if [ -n "${XCI_INFRA_PROTO}" ]; then
    set -o nounset
    if [ "${XCI_INFRA_PROTO}" == "infra_manager" ]; then
        #-----------------------------------------------------------------------
        # Start provisioning baremetal nodes using infra_manger proto
        #-----------------------------------------------------------------------
