...
7. Run ONAP Health Check by running the instructions as mentioned in
   https://onap.readthedocs.io/en/amsterdam/guides/onap-developer/settingup/fullonap.html#test-the-installation.
